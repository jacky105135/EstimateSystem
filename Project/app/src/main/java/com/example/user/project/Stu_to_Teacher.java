...
public class Stu_to_Teacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stu_to__teacher);
        ...
        gradeconfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                t1.start();
                Stu_to_Teacher.this.finish();
                Toast.makeText(Stu_to_Teacher.this, "回饋已送出", Toast.LENGTH_SHORT).show();
            }
            Thread t1 = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    request.addProperty("name",Tname);
